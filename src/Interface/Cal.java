/*
 * Copyright [2024] [Shehroz Hamza ID: BSE-22f-144]
 *
...
public class Cal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(611, 514));
        ...
        jPanel1.add(txtdisplay, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 550, 70));
        ...
        jLabel1.setMaximumSize(new java.awt.Dimension(813, 478));
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 590, 470));

        jLabel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 570, 450));
        ...
        jPanel1.add(btn21, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 320, 70, 50));
        ...
        jPanel1.add(btn22, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 380, 70, 50));
        ...
        jPanel1.add(btn23, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 110, 70, 50));
        ...
        jPanel1.add(btn24, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 180, 70, 50));
        ...
        jPanel1.add(btn25, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 250, 70, 50));
        ...
        jPanel1.add(btn26, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 380, 70, 50));

        btn27.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn27.setText("Root");
        btn27.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btn27.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn27ActionPerformed(evt);
            }
        });
        jPanel1.add(btn27, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 110, 70, 50));

        btn28.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn28.setText("Back");
        btn28.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btn28.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn28ActionPerformed(evt);
            }
        });
        jPanel1.add(btn28, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 320, 70, 110));

        btn29.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn29.setText("tanh");
        btn29.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btn29.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn29ActionPerformed(evt);
            }
        });
        jPanel1.add(btn29, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 250, 70, 50));
        ...
        jPanel1.add(btn30, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 320, 70, 50));
        ...
        jPanel1.add(btn31, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 110, 70, 50));
        ...
        jPanel1.add(btn32, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 180, 70, 50));
        ...
        jPanel1.add(btn33, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 180, 70, 50));
        ...
        jPanel1.add(btn34, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 250, 70, 50));
 ...
 */
   ...
   double t = Math.cos(Double.parseDouble(txtdisplay.getText()));
        txtdisplay.setText("");
        txtdisplay.setText(txtdisplay.getText() + t);    }//GEN-LAST:event_btn21ActionPerformed
    ...
    private void btn23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn23ActionPerformed
        ...
        t = t*t;
        txtdisplay.setText("");
        txtdisplay.setText (txtdisplay.getText() + t);  // TODO add your handling code here:
    ...
    private void btn25ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn25ActionPerformed
        double t = Math.sin(Double.parseDouble(txtdisplay.getText()));
        txtdisplay.setText("");
        txtdisplay.setText(txtdisplay.getText() + t);
 ...
 double t = Math.exp(Double.parseDouble(txtdisplay.getText()));
        txtdisplay.setText("");
        txtdisplay.setText(txtdisplay.getText() + t);    }//GEN-LAST:event_btn26ActionPerformed

    private void btn27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn27ActionPerformed
 double t = Math.sqrt(Double.parseDouble(txtdisplay.getText()));
        txtdisplay.setText("");
        txtdisplay.setText(txtdisplay.getText() + t);    }//GEN-LAST:event_btn27ActionPerformed
    ...
    private void btn28ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn28ActionPerformed
        ...
        if(txtdisplay.getText().length()> 0){
            StringBuilder s= new StringBuilder(txtdisplay.getText());
                ...
                s.deleteCharAt(txtdisplay.getText().length() -1);
 ...
 double t = Math.tanh(Double.parseDouble(txtdisplay.getText()));
        txtdisplay.setText("");
        txtdisplay.setText(txtdisplay.getText() + t);    }//GEN-LAST:event_btn29ActionPerformed

    private void btn30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn30ActionPerformed
 double t = Math.log(Double.parseDouble(txtdisplay.getText()));
        txtdisplay.setText("");
        txtdisplay.setText(txtdisplay.getText() + t);    }//GEN-LAST:event_btn30ActionPerformed

    private void btn31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn31ActionPerformed
          double t = Math.sinh(Double.parseDouble(txtdisplay.getText()));
        txtdisplay.setText("");
        txtdisplay.setText(txtdisplay.getText() + t);
    }//GEN-LAST:event_btn31ActionPerformed

    private void btn32ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn32ActionPerformed
         double t = Math.cosh(Double.parseDouble(txtdisplay.getText()));
        txtdisplay.setText("");
        txtdisplay.setText(txtdisplay.getText() + t);
